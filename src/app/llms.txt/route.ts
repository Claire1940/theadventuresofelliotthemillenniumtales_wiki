...
export async function GET() {
  const baseUrl = process.env.NEXT_PUBLIC_SITE_URL || 'https://theadventuresofelliotthemillenniumtales.wiki'
  const siteName = process.env.NEXT_PUBLIC_SITE_NAME || 'The Adventures of Elliot: The Millennium Tales Wiki'
